...
export const Dashboard_Templates = ()=>{
    ...
    return (
        <Box  w="75%" mx="auto" >
            ...
            <Flex p="4">
                <Heading textAlign="left" fontSize="3xl" color="green.900">Templates</Heading>
                <Spacer />
                <Button onClick={handleClick} colorScheme="red">New Template</Button>
            </Flex>
            ...
            >
                ...
                <Center>
                    <Button borderRadius="50px" maxW="fit-content" colorScheme="red">Create my first template</Button>
                </Center>
